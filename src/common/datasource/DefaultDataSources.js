...
const configList = [
  BilibiliDataSource.withUid(161775300, (config) => {
    config.icon('/assets/image/icon/bili.ico').dataName('官方B站动态').title('哔哩哔哩').priority(0);
  }),
  WeiboDataSource.withUid(6279793937, (config) => {
    config.icon('/assets/image/icon/weibo.ico').dataName('官方微博').title('微博').priority(1);
  }),
  ...
  WeiboDataSource.withUid(6441489862, (config) => {
    config.icon('/assets/image/icon/cho3Weibo.jpg').dataName('朝陇山微博').title('朝陇山').priority(3);
  }),
  ...
  NeteaseCloudMusicDataSource.withUid(32540734, (config) => {
    config.icon('/assets/image/wyyyy.ico').dataName('塞壬唱片网易云音乐').title('网易云音乐').priority(9);
  }),
  ...
  BilibiliDataSource.withUid(1883857209, (config) => {
    config.priority(12).groupId(SHARE_DEFAULT_GROUP);
  }),
  BilibiliDataSource.withUid(1554642444, (config) => {
    config.priority(13).groupId(SHARE_DEFAULT_GROUP);
  }),
  BilibiliDataSource.withUid(2123591088, (config) => {
    config.priority(14).groupId(SHARE_DEFAULT_GROUP);
  }),
  WeiboDataSource.withUid(7683268725, (config) => {
    config.priority(15).groupId(SHARE_DEFAULT_GROUP);
  }),
