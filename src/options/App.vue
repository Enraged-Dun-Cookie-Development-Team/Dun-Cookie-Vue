                    ...
                    <template #default="{ node, data }">
                      <span class="checkbox-area">
                        ...
                        <el-button
                          ...
                          type="text"
                          size="mini"
                          @click="removeCustomDataSource(data.idStr)"
                          >删除</el-button
                        >
                      </span>
                    </template>
                    ...
                    <template v-if="enableCustom">
                      ...
                      <el-dialog title="新增自定义数据源" :visible.sync="showAddCustomDialog">
                        ...
                        <div slot="footer" class="dialog-footer">
                          <el-button :loading="customDataSourceChecking" @click="addCustomDataSource()"
                            >确 定</el-button
                          >
...
import { MESSAGE_WEIBO_ADD_REFERER, SHOW_VERSION } from '../common/Constants';
