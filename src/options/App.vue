            ...
            <div ref="system-form" class="system system-form">
              <div class="body-menu-content-card">
                ...
                <div class="content-card-content">
                  <DataSourceSelect ref="dataSourceSelect" show-btn />
                </div>
              </div>
              <div class="flex">
                <div class="body-menu-content-card">
...
export default {
  name: 'App',
  components: { DataSourceSelect, countTo },
  data() {
    return {
      logo: '',
  ...
  methods: {
    ...
    saveSetting(formName, data) {
      ...
      this.$refs[formName].validate((valid) => {
        ...
        const selectDataSource = this.$refs.dataSourceSelect.getSelectDataSourceList();
        if (selectDataSource.length > 0) {
          this.settings.enableDataSources = selectDataSource;
          /* IFTRUE_feature__custom_datasource */
          this.settings.extraFeature.enableCustomDataSources =
            this.$refs.dataSourceSelect.getSelectCustomDataSourceList();
